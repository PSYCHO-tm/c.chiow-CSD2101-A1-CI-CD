...
// include: C:\Users\user\AppData\Local\Temp\tmpg98w_5xd.js
...
Module['FS_createPath']("/assets", "shader", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/shader/BlueTriangleFragment.glsl", "start": 0, "end": 143}, {"filename": "/assets/shader/BlueTriangleVertex.glsl", "start": 143, "end": 597}, {"filename": "/assets/shader/SquareFragment.glsl", "start": 597, "end": 727}, {"filename": "/assets/shader/SquareVertex.glsl", "start": 727, "end": 962}], "remote_package_size": 962});

  })();

// end include: C:\Users\user\AppData\Local\Temp\tmpg98w_5xd.js
// include: C:\Users\user\AppData\Local\Temp\tmpa3gqr2cc.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\user\AppData\Local\Temp\tmpa3gqr2cc.js
// include: C:\Users\user\AppData\Local\Temp\tmp9r1qqcdr.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\user\AppData\Local\Temp\tmp9r1qqcdr.js
